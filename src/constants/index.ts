...
// CREST 앱 상수 정의
// ============================================
import type { SellPreset, ProfitStage, StockInfo, EarningsInfo, MarketCycleData } from '../types';
...
/** 실적 데이터 */
export const EARNINGS_DATA: Record<string, EarningsInfo> = {
...
/** 시장 사이클 (코스톨라니 달걀) */
export const MARKET_CYCLE: MarketCycleData = { 
  currentPhase: 4, 
  phaseName: '금리인상 논의', 

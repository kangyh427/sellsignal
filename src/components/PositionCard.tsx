...
// 세션 26B: 스와이프 삭제 통합 (useSwipeToDelete) + 시그널 border
// 변경사항(26B):
//   - useSwipeToDelete 훅 통합 (모바일 좌측 스와이프 → 삭제 버튼)
//   - 접힌/펼친 카드 모두 스와이프 래퍼 적용
//   - 시그널 레벨에 따른 카드 border 색상
//   - 펼친 카드 하단 스와이프 힌트 텍스트
// ============================================

...
// 세션 34: 로그인 prop 수정 + 3컬럼 복원 + 좌측 광고
// 세션 35: InstallPrompt 추가 + 한글 인코딩 복구 (UTF-8)
// ============================================
...
import InstallPrompt from './InstallPrompt';      // ★ 세션 35: PWA 설치 안내
import ServiceWorkerRegister from './ServiceWorkerRegister'; // ★ 세션 35: SW 등록

'use client';
// ============================================
// AIReportPopup - AI 리포트 분석 팝업
// 경로: src/components/AIReportPopup.tsx
// 세션4(아키텍처 정리)에서 SellSignalApp.tsx L278-514 분리
// ============================================
// 모바일 최적화:
//   - 모바일에서 바텀시트 스타일 (하단 슬라이드업)
//   - 목표가 그리드 모바일 2×2 / 데스크톱 4열
//   - safe-area-inset 대응
// ============================================
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <div style={{ textAlign: 'center' }}>
                    ...
                    >
                      {reportData.targetPriceConsensus.upside > 0 ? '+' : ''}
              ...
              <div style={{ background: 'rgba(0,0,0,0.2)', borderRadius: '12px', padding: '16px', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  {[
                    { label: '매수', count: reportData.investmentOpinion.buy, color: '#10b981' },
                    { label: '보유', count: reportData.investmentOpinion.hold, color: '#eab308' },
                    { label: '매도', count: reportData.investmentOpinion.sell, color: '#ef4444' },
                  ].map((item, i) => (
                    <div
                      key={i}
                      style={{

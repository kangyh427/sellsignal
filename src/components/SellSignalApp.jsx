...
const Footer = ({ isMobile }) => {
  return (
    <footer style={{
      ...
      padding: isMobile ? '32px 16px 100px' : '48px 24px 32px',
      marginTop: '40px',
    }}>
      <div style={{
        maxWidth: '1200px',
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ 
              ...
              수익 단계별 최적의 매도 타이밍을 알려주는 스마트 투자 도구
            </p>
          </div>
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <p style={{ margin: '0 0 4px' }}>
              ...
              <span style={{ color: '#64748b', marginLeft: '8px' }}>이메일:</span> kangyh427@naver.com
            </p>
            <p style={{ margin: 0 }}>
        ...
        <div style={{
          ...
          <p style={{ 
            ...
            © 2025 매도의 기술 (sellsignal.kr). All rights reserved.
          </p>
        </div>
      </div>
    </footer>
...
export default function SellSignalAppV5() {
  ...
  return (
    <div style={{ 
      ...
      {/* Footer - 데스크톱에서만 표시 (모바일은 하단 네비게이션이 있음) */}
